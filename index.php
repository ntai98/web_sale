    ...
    <div id="noidung">
        ...
        <div id="noidungchinh">
            ...
            <div id="sanphammoi">
                <h3>SẢN PHẨM MỚI</h3>
                <?php
                $jsondata = file_get_contents('http://localhost/banhang/api/hanghoa');
                $json = json_decode($jsondata,true);
                for($j=count($json);$j>count($json)-16;$j--){
                    echo "<div class=\"sp\">";
                    echo("<a href=\"sanpham.php?id=".$json[$j-1]['mahang'] ."\" target=\"\"><img src=\"hinh/"
                        .$json[$j-1]['hinh'] ."\" width=\"100%\" height=\"280px\"></a>" );
                    echo"<br>";
                    echo"<br>";

                    echo("<a href=\"sanpham.php?id=".$json[$j-1]['mahang'] ."\" target=\"\"> " .$json[$j-1]['tenhang'] ."</a>" );
                    echo"<br>";
                    echo"<br>";
                    echo("<p align=\"center\">" .$json[$j-1]['gia'] ."VNĐ" ."</p>");
                    echo "</div>";
                }
                ?>
            </div>
