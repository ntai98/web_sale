                    ...
                    <div id="noidungchinh">
                        ...
                        <div id="sanphammoi">
                            ...
                            if (isset($_GET['search'])) {
                                ...
                                $jsondatath = file_get_contents('http://localhost/banhang/api/hanghoa/?tenhang=' .$search);
                                $jsonth = json_decode($jsondatath,true);
                                if(count($jsonth) == 0){
                                    echo "không tìm thấy!";
                                }else {
                                    foreach ($jsonth as $hh) {
                                        echo "<div class=\"sp\">";
                                        echo("<a href=\"sanpham.php?id=" .$hh['mahang']  ."\" target=\"\"><img src=\"hinh/"
                                            .$hh['hinh'] ."\" width=\"100%\" height=\"280px\"></a>");
                                        echo "<br>";
                                        echo "<br>";
